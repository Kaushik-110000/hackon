...
export default function GreenStore() {
  ...
  const ecoProducts = [
    ...
    },
    {
      ...
      isEcoFriendly: true,
      badges: ['energy-efficient', 'carbon-neutral'] as const,
      image: '/assests/mockProducts_images/zebronics.jpg',
  ...
  return (
    <div className="bg-[#E3E6E6] min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Climate Pledge Friendly</h1>
          <p className="text-sm text-gray-600">Discover eco-friendly products that help reduce your carbon footprint</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 mb-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-green-100">Every purchase helps protect our planet. Earn green coins for eco-friendly choices!</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button className="px-3 py-1.5 bg-green-100 text-green-700 rounded text-xs font-medium">All Products</button>
            <button className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded text-xs font-medium hover:bg-green-100 hover:text-green-700">High Green Score (80+)</button>
            <button className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded text-xs font-medium hover:bg-green-100 hover:text-green-700">Organic</button>
            <button className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded text-xs font-medium hover:bg-green-100 hover:text-green-700">Recycled</button>
            <button className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded text-xs font-medium hover:bg-green-100 hover:text-green-700">Energy Efficient</button>
          </div>
        </div>
          ...
          {ecoProducts.map((product) => (
            <div key={product.id} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow border border-gray-200">
              ...
              <div className="p-3">
                ...
                {/* Carbon Savings */}
                <div className="text-xs text-green-600 mb-2 font-medium">{product.savings}</div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mt-6">
          <h2 className="text-lg font-semibold mb-4">Your environmental impact</h2>
